...
//        assertEquals("david", validation().isNotNull(str).<String>ifNotValid("david").getIfResult());
    ...
    public void isNotNullTest(){
        ...
        assertTrue(validation().val("123", 24).isNotNull().isValid());
        ...
        assertFalse(validation().val(null, null, null).isNotNull().isValid());
        assertFalse(validation().isNotNull(null, null).isValid());

        assertFalse(validation().val(null, 122).isNotNull().isValid());
        assertFalse(validation().val(12, null).isNotNull().isValid());
