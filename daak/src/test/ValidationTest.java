...
//--
        ...
        assertFalse(validation().val("123", 24).isNull2Value().isValid());
        assertFalse(validation().isNull(123, 22).isValid());

        assertTrue(validation().val(null).isNull().isValid());
        assertTrue(validation().isNull(null).isValid());

        assertTrue(validation().val(null, null).isNull2Value().isValid());
        assertTrue(validation().isNull(null, null).isValid());

        assertFalse(validation().val(null, 122).isNull2Value().isValid());
        assertFalse(validation().val(12, null).isNull2Value().isValid());

        assertFalse(validation().isNull(null, 123).isValid());
        assertFalse(validation().isNull(12, null).isValid());

        //----------
        assertTrue(validation().val("123").isNotNull().isValid());
        assertTrue(validation().isNotNull(123).isValid());

        assertTrue(validation().val("123", 24).isNotNull2Value().isValid());
        assertTrue(validation().isNotNull(123, 22).isValid());

        assertFalse(validation().val(null).isNotNull().isValid());
        assertFalse(validation().isNotNull(null).isValid());

        assertFalse(validation().val(null, null).isNotNull2Value().isValid());
        assertFalse(validation().isNotNull(null, null).isValid());

        assertFalse(validation().val(null, 122).isNotNull2Value().isValid());
        assertFalse(validation().val(12, null).isNotNull2Value().isValid());

        assertFalse(validation().isNotNull(null, 123).isValid());
        assertFalse(validation().isNotNull(12, null).isValid());
//--
